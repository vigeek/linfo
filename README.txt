...
Nixutils is a light weight portable set of bash scripts to generate statistics for Linux systems.  Each script can be used independently from each other or download the whole set of scripts.
